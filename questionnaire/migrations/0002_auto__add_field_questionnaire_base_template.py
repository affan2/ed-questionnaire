...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Questionnaire.base_template'
        db.add_column(u'questionnaire_questionnaire', 'base_template',
                      self.gf('django.db.models.fields.CharField')(default='/surveys/base.html', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Questionnaire.base_template'
        db.delete_column(u'questionnaire_questionnaire', 'base_template')
