...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'questionnaire_runinfohistory', 'completed', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'RunInfoHistory.completed'
        db.alter_column(u'questionnaire_runinfohistory', 'completed', self.gf('django.db.models.fields.DateField')())
