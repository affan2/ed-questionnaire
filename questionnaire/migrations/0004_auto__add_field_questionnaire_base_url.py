...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Questionnaire.base_url'
        db.add_column(u'questionnaire_questionnaire', 'base_url',
                      self.gf('django.db.models.fields.CharField')(default='/$LANG/', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Questionnaire.base_url'
        db.delete_column(u'questionnaire_questionnaire', 'base_url')
